            ...
            <div class="hidden sm:ml-6 sm:block">
              ...
              <div class="dropDown">
                ...
                <div class="dropDownContent">
                  <a href="/C_Registrar_Dashboard">Dashboard</a> 
                  <a href="/C_Registrar_Profile/logout">Log-out</a>
                </div>
              </div>
      ...
      <div class="cont">
        ...
        <div class="profile">
          ...
          <div class="profilePicture">
            <form action="/C_Registrar_Profile/imageUpload" method="post" enctype="multipart/form-data">
          ...
          <div class="changePass" >
            <form action="/C_Registrar_Profile/changePass" method="post" target="_self">
